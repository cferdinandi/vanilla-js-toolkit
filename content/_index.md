...
<p class="text-large">{{%md%}}A growing collection of [code snippets](/code-snippets), [helper functions](/helper-functions), [polyfills](/polyfills), [plugins](/plugins), and [learning resources](/resources), by [Chris Ferdinandi](https://gomakethings.com).{{%/md%}}</p>
